...
const News = () => {
    return (
        <div className="my-5">
            ...
            <p>Exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo non habent claritatem insitam consequat duis autem</p>
            </div>
    ...
    <div className="rounded overflow-hidden shadow-lg flex flex-col">
      ...
      <div className="relative">
        <a href="#">
          <img
            className="w-full"
            src="https://img.freepik.com/free-photo/male-doctor-examining-patient_1170-2157.jpg?w=740&t=st=1709100690~exp=1709101290~hmac=a1900a9bdc2dc83fe236cc9e360cb7c81be2eb526470172f84990481cc6a1d63
            "
      ...
      <div className="px-6 py-4 mb-auto">
        ...
        <p className="text-gray-500 text-sm">
          Ut wisi enim ad minim veniam, quis laore nostrud exerci tation ulm hedi corper turet ipsum dolor sit amet, consectetuer adipiscing elit, sed diam.........
        </p>
      </div>
    ...
    <div className="rounded overflow-hidden shadow-lg flex flex-col">
      ...
      <div className="relative">
        <a href="#">
          <img
            className="w-full"
            src="https://img.freepik.com/free-photo/doctor-handshaking-with-patient_23-2147648723.jpg?w=740&t=st=1709100695~exp=1709101295~hmac=253736ece9464817a76eee9ecb7dac87de7e2da6e59b5ac8543589d6d5f33bbd"
            alt="Sunset in the mountains"
          />
          <div className="hover:bg-transparent transition duration-300 absolute bottom-0 top-0 right-0 left-0 bg-gray-900 opacity-25"></div>
        </a>
    ...
    <div className="rounded overflow-hidden shadow-lg flex flex-col">
      ...
      <div className="relative">
        <a href="#">
          <img
            className="w-full"
            src="https://img.freepik.com/free-photo/side-view-doctor-writing-prescription_23-2148231339.jpg?w=740&t=st=1709100700~exp=1709101300~hmac=3bbd7a5641fef6e335d136b0bc568fd4075f3efcdb9ab4156e2e8f486b93ecd8"
            alt="Sunset in the mountains"
          />
          <div className="hover:bg-transparent transition duration-300 absolute bottom-0 top-0 right-0 left-0 bg-gray-900 opacity-25"></div>
        </a>
